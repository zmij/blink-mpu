...
#define APB2_PERIPH_BASE 0x40002400
#define APB2_PERIPH_SIZE 0x100

struct APB2_leds_peripheral {
	volatile uint32_t the_led : 1;
};

APB2_leds_peripheral* leds = (APB2_leds_peripheral*)APB2_PERIPH_BASE;
